...
// $variableP01="El ID es: ".$idUsuario."<--";
// $variableP02="SELECT alcanse,fecha FROM pro_proyecto WHERE idUsuario=1208012175;";
// $variableP03= $idUsuario;
// echo json_encode($variableP03);